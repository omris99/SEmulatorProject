package serverengine.logic.model.argument.commaseperatedarguments;
...
public class CommaSeperatedArguments implements Argument {
    ...
    public String getUserDisplayArguments() {
        ...
        for (String argument : extractedArguments) {
            if (VariableImpl.stringVarTypeToVariableType(argument.substring(0, 1)) != null) {
                ...
                newArguments.add(ProgramsRepo.getInstance().getFunctionUserString(argument));
            }
        }
    ...
    public int getTotalCycles() {
        ...
        for (String argument : extractedArguments) {
            ...
            } else if (ProgramsRepo.getInstance().getFunctionByName(argument) != null) {
                totalCycles += ProgramsRepo.getInstance().getFunctionByName(argument).getTotalCycles();
            }
        }
