...
//                    Platform.runLater(() -> {
//                        debuggerWindowController.updateRunResultsAndFinishExecutionModeIfNeeded(runResultsDTO);
//                        finishExecutionMode();
//                    });
//                }
//                else {
...
//                    Platform.runLater(() -> {
//                        debuggerWindowController.startDebugMode();
//                        debuggerWindowController.updateRunResultsAndFinishExecutionModeIfNeeded(initialState);
...
//                    Platform.runLater(() -> debuggerWindowController.updateRunResultsAndFinishExecutionModeIfNeeded(context));
...
//                    RunResultsDTO context = GsonFactory.getGson().fromJson(responseBodyString, RunResultsDTO.class);
//                    Platform.runLater(() -> {
//                        debuggerWindowController.updateRunResultsAndFinishExecutionModeIfNeeded(context);
//                        fetchAndHighlightNextInstructionToExecute();
//                    });
//
//                }
...
//        debuggerWindowController.finishDebugMode();
